  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.Viewport
        ...
        className="h-full w-full max-h-[inherit] rounded-[inherit] transition-[color,box-shadow] outline-none focus-visible:ring-3 focus-visible:ring-ring/50 focus-visible:outline-1"
