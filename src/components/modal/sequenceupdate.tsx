  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-secondary text-xs font-semibold leading-none text-secondary-foreground">
          {sequence}
        </span>
