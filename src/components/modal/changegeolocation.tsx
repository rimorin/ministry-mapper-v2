...
const SearchControl = ({
  ...
  useEffect(() => {
    ...
    // Add country filter from origin (e.g., "sg" for Singapore)
    if (origin) {
        ...
        <Form onSubmit={handleUpdateGeoLocation}>
          ...
          >
            ...
            >
              ...
              <SearchControl
                onLocationSelect={setAddressLocation}
                origin={origin}
              />
              <MapController center={addressLocation} />
              ...
              <CustomControl position="topright">
                <MapCurrentTarget
                  onClick={() =>
                    setAddressLocation({
                      lat: currentLocation?.lat ?? coordinates.lat,
                      lng: currentLocation?.lng ?? coordinates.lng
                    })
                  }
                />
              </CustomControl>
