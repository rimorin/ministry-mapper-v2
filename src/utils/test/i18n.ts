...
const resources = {
  en: {
    translation: {
      ...
      // Slip
      "slip.confirmRegularTitle": "Confirm slip details for {{addressName}}",
      "assignments.assignedTo": "Assigned to",
      "assignments.expires": "Expires",
      "slip.publisherNamePlaceholder": "Names of the assigned publishers",
      "slip.confirmButton": "Confirm",
