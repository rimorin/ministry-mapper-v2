...
const STATUS_CODES_DESCRIPTION = {
  [STATUS_CODES.DEFAULT]: "Not Done",
  [STATUS_CODES.DONE]: "Done",
  [STATUS_CODES.NOT_HOME]: "Not Home",
  [STATUS_CODES.STILL_NOT_HOME]: "Still Not Home",
  [STATUS_CODES.DO_NOT_CALL]: "Do Not Call",
  [STATUS_CODES.INVALID]: "Invalid"
};
...
const REMOTE_CONFIG_FETCH_INTERVAL_MS_DEFAULT = 3600000;

const MULTI_BATCH_ACTIONS = {
  DELETE: "delete",
  UPDATE: "update",
  SET: "set"
};

// This is the maximum number of documents that can be processed in a single firestore batch write.
