...
**Version Notice** V2 of Ministry Mapper is currently in development. The new version will be a complete rewrite of the application using ReactJs, Typescript, and Sqlite. The new version will remove the dependency on Firebase. The new version will be available in the near future.
